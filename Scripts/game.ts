...
{
    createjs.Sound.registerSound({ id: "fail", src: "assets/audio/Fail.mp3" });
    createjs.Sound.addEventListener("fileload", handleFileLoad);
    function handleFileLoad(event) {
        // A sound has been preloaded.
        if (event.id == 'fail') {
            var soundInstance = createjs.Sound.play("fail");
    ...
    function resetAudio() {
        ...
        createjs.Sound.removeSound("assets/audio/Fail.mp3", "");
    }
}

function playWinSound() {
    createjs.Sound.registerSound({ id: "win", src: "assets/audio/Win.mp3" });
    createjs.Sound.addEventListener("fileload", handleFileLoad);
    function handleFileLoad(event) {
        // A sound has been preloaded.
        if (event.id == 'win') {
            var soundInstance = createjs.Sound.play("win");
            soundInstance.on("complete", resetAudio);
        }
    }
    ...
    function resetAudio() {
        ...
        createjs.Sound.removeSound("assets/audio/Win.mp3", "");
    }
}
...
function createUI():void {
    ...
    spinButton.getImage().addEventListener("click", loadCoin);
    ...
    powerButton.getImage().addEventListener("click", reset);
    ...
    createjs.Sound.registerSound({ id: "backSound", src: "assets/audio/background.mp3" });
    createjs.Sound.addEventListener("fileload", handleFileLoad);
    function handleFileLoad(event) {
        // A sound has been preloaded.
        if (event.id == 'backSound') {
 ...
 function reset() {
    ...
    game.removeChild(powerButton.getImage());
     ...
     powerButton.getImage().addEventListener("click", reset);
    game.addChild(powerButton.getImage());
    createjs.Sound.registerSound({ id: "power", src: "assets/audio/powerOn.mp3" });
    createjs.Sound.addEventListener("fileload", handleFileLoad);

    function handleFileLoad(event) {
        // A sound has been preloaded.
        if (event.id == 'power') {
            var soundInstance = createjs.Sound.play("power");
            soundInstance.on("complete", resetAudio);
        }
    }
    ...
    function resetAudio() {
        console.log("Reached");
        createjs.Sound.removeSound("assets/audio/powerOn.mp3", "");
    }
}
